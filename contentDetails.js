...
function dynamicContentDetails(ob) {
  ...
  // Review Text Box and Rating System
  let reviewSection = document.createElement("div");
  reviewSection.id = "reviewSection";

  let h3Review = document.createElement("h3");
  h3Review.textContent = "Write a Review";
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    star.className = "star";
    star.innerHTML = "&#9733;";
    star.setAttribute("onclick", "rateProduct(" + i + ")");
  ...
  reviewSection.appendChild(h3Review);
  reviewSection.appendChild(reviewText);
  reviewSection.appendChild(ratingSection);
